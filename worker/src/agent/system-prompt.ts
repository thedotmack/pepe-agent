...
export const SYSTEM_PROMPT: string = [
  ...
  "- HOW: call `get_open_positions` first; copy the exact tokens-to-sell figure from the row. NEVER guess `sellAmountTokens`.",
  ...
  "- Sells are not blocked by the daily BUY cap — emergency exits always go through.",
  "",
  "## Discipline",
